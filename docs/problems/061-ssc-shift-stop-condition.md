...
[ヒント](../hints/061-ssc-shift-stop-condition.md) / [解答](../solutions/061-ssc-shift-stop-condition.md)

**難易度:** ☆☆☆☆

## 問題

レポートにあった、Shift命令で値を2倍し続けるプログラムを考えます。
...
- `signed8_shift_until_stop` は、レポートの停止条件を説明するための別関数です。
- 8ビット符号付きへの変換では、値を256で割った余りにしてから、128以上なら256を引いてください。
